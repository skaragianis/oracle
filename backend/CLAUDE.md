...
- The CLI and server are separate apps within the same package — avoid coupling one to the other's internals; shared logic should live in a common module both import rather than one importing the other's app-specific code.
